...
public class DeadFish : MonoBehaviour
{
	private void Start()
	{
		GameObject prefab = GreenHellGame.Instance.GetPrefab("Blood Effect");
		GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(prefab);
		gameObject.transform.position = this.m_HitPos;
		...
		this.m_WaterBoxCollider = ((!this.m_Tank.m_Water) ? this.m_Tank.GetComponent<BoxCollider>() : this.m_Tank.m_Water.GetComponent<BoxCollider>());
	}
